 ...
 *
 * @param {Object} newRating - The new rating data to be saved.
...
/**
 * Retrieves all ratings associated with a specific job ID.
 *
 * @param {string} jobID - The ID of the job whose ratings are to be retrieved.
 * @returns {Promise<Array>} - A promise that resolves to an array of ratings for the specified job.
 */
 ...
 * @param {Object} updatedData - The updated rating data.
